...
HL_PRIM void kinc_hl_g4_set_texture3d_magnification_filter(kinc_g4_texture_unit_t *texunit, kinc_g4_texture_filter_t filter){kinc_g4_set_texture3d_magnification_filter(*texunit,filter);}
...
HL_PRIM void kinc_hl_g4_set_texture3d_minification_filter(kinc_g4_texture_unit_t* texunit, kinc_g4_texture_filter_t filter) { kinc_g4_set_texture3d_minification_filter(*texunit, filter); }
...
HL_PRIM void kinc_hl_g4_set_texture3d_mipmap_filter(kinc_g4_texture_unit_t* texunit, kinc_g4_mipmap_filter_t filter) { kinc_g4_set_texture3d_mipmap_filter(*texunit, filter); }

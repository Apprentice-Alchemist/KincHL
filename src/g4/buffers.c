...
DEFINE_PRIM(_BYTES, hl_g4_vertex_buffer_lock, _ABSTRACT(kinc_g4_vertex_buffer_t) _I32 _I32)
DEFINE_PRIM(_BYTES, hl_g4_vertex_buffer_lock_all, _ABSTRACT(kinc_g4_vertex_buffer_t))
...
DEFINE_PRIM(_BYTES, hl_g4_index_buffer_lock, _ABSTRACT(kinc_g4_index_buffer_t))

...
HL_PRIM void HL_NAME(hl_g4_render_target_use_color_as_texture)(hl_g4_render_target* renderTarget, kinc_g4_texture_unit_t* unit) { kinc_g4_render_target_use_color_as_texture(&renderTarget->t, *unit); }
HL_PRIM void HL_NAME(hl_g4_render_target_use_depth_as_texture)(hl_g4_render_target* renderTarget, kinc_g4_texture_unit_t* unit) { kinc_g4_render_target_use_depth_as_texture(&renderTarget->t, *unit); }
HL_PRIM void HL_NAME(hl_g4_render_target_set_depth_stencil_from)(hl_g4_render_target* renderTarget, hl_g4_render_target* source) { kinc_g4_render_target_set_depth_stencil_from(&renderTarget->t, &source->t); }
HL_PRIM void HL_NAME(hl_g4_render_target_get_pixels)(hl_g4_render_target* renderTarget, vbyte* data) { kinc_g4_render_target_get_pixels(&renderTarget->t, data); }
HL_PRIM void HL_NAME(hl_g4_render_target_generate_mipmaps)(hl_g4_render_target* renderTarget, int levels) { kinc_g4_render_target_generate_mipmaps(&renderTarget->t, levels); }

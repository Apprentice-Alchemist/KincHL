...
// MAKE_GET_SET_EX(g4_render_target, framebuffer_index, int, _I32)
MAKE_GET_SET_EX(g4_render_target, isCubeMap, bool, _BOOL)
MAKE_GET_SET_EX(g4_render_target, isDepthAttachment, bool, _BOOL)

HL_PRIM void HL_NAME(hl_g4_render_target_init)(hl_g4_render_target *renderTarget, int width, int height,
                                               kinc_g4_render_target_format_t format, int depthBufferBits, int stencilBufferBits) {
    kinc_g4_render_target_init(&renderTarget->t, width, height, format, depthBufferBits, stencilBufferBits);
}
HL_PRIM void HL_NAME(hl_g4_render_target_init_with_multisampling)(hl_g4_render_target *renderTarget, int width, int height,
                                                                  kinc_g4_render_target_format_t format, int depthBufferBits, int stencilBufferBits, int samples_per_pixel) {
    kinc_g4_render_target_init_with_multisampling(&renderTarget->t, width, height, format, depthBufferBits, stencilBufferBits, samples_per_pixel);
}
HL_PRIM void HL_NAME(hl_g4_render_target_init_cube)(hl_g4_render_target *renderTarget, int size,
                                                    kinc_g4_render_target_format_t format, int depthBufferBits, int stencilBufferBits) {
    kinc_g4_render_target_init_cube(&renderTarget->t, size, format, depthBufferBits, stencilBufferBits);
}
HL_PRIM void HL_NAME(hl_g4_render_target_init_cube_with_multisampling)(hl_g4_render_target *renderTarget, int size,
                                                                       kinc_g4_render_target_format_t format, int depthBufferBits, int stencilBufferBits, int samples_per_pixel) {
    kinc_g4_render_target_init_cube_with_multisampling(&renderTarget->t, size, format, depthBufferBits, stencilBufferBits, samples_per_pixel);
}
...
DEFINE_PRIM(_VOID, hl_g4_render_target_init, _RENDER_TARGET _I32 _I32 _I32 _I32 _I32)
DEFINE_PRIM(_VOID, hl_g4_render_target_init_with_multisampling, _RENDER_TARGET _I32 _I32 _I32 _I32 _I32 _I32)
DEFINE_PRIM(_VOID, hl_g4_render_target_init_cube, _RENDER_TARGET _I32 _I32 _I32 _I32)
DEFINE_PRIM(_VOID, hl_g4_render_target_init_cube_with_multisampling, _RENDER_TARGET _I32 _I32 _I32 _I32 _I32)

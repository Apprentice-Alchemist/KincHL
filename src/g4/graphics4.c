...
HL_PRIM void HL_NAME(hl_g4_set_vertex_buffers)(varray* bufs) { kinc_g4_set_vertex_buffers(hl_aptr(bufs, kinc_g4_vertex_buffer_t*), bufs->size); }
...
HL_PRIM void HL_NAME(hl_g4_set_render_targets)(varray* targets) { kinc_g4_set_render_targets(hl_aptr(targets, kinc_g4_render_target_t*), targets->size); }

...
MAKE_GET_SET(kinc_image_t, image, depth, int, _ABSTRACT(kinc_image_t), _I32)
MAKE_GET_SET(kinc_image_t, image, data_size, int, _ABSTRACT(kinc_image_t), _I32)
MAKE_GET_SET(kinc_image_t, image, format, int, _ABSTRACT(kinc_image_t), _I32)
...
HL_PRIM void HL_NAME(hl_image_init_from_bytes)(kinc_image_t* img, void* mem, int w, int h, int format) {
...
DEFINE_PRIM(_VOID,hl_image_init_from_bytes,_ABSTRACT(kinc_image_t) _BYTES _I32 _I32 _I32)